    ...
    return (
        <div className="border-b border-zinc-700 hover:border-transparent">
            <Link
                ...
                passHref
                key={data.id}
                className="flex w-full items-center justify-between transition-all duration-200 hover:bg-zinc-800 rounded sm:py-2  "
            >
                ...
                <TooltipComponent content="Copy link to clipboard" side="bottom" >
                    ...
                    >
                        <Square2StackIcon className="h-5 w-5 text-zinc-200" />
                    </button>
                </TooltipComponent>
            </Link>
        </div>
