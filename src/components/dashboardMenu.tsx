import { ArrowLeftIcon, ArrowRightOnRectangleIcon, Bars3Icon, ChartBarIcon, Cog6ToothIcon, DocumentIcon, PlusIcon, TrashIcon, UserCircleIcon, WrenchScrewdriverIcon, XMarkIcon } from "@heroicons/react/24/solid";
